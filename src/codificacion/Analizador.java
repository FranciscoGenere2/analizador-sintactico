...
public class Analizador extends javax.swing.JFrame {
    ...
    public Analizador() {
        ...
        setIconImage(new ImageIcon(getClass().getResource("/Imagenes/checkIco.png")).getImage());
    }
    ...
    private void initComponents() {
        ...
        btnArchivo.setForeground(new java.awt.Color(153, 153, 255));
        btnArchivo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/enPC.png"))); // NOI18N
        btnArchivo.setBorderPainted(false);
        btnArchivo.setMaximumSize(new java.awt.Dimension(289, 265));
        btnArchivo.setMinimumSize(new java.awt.Dimension(64, 64));
        btnArchivo.setPreferredSize(new java.awt.Dimension(289, 265));
        ...
        btnAnalizarLex.setText("Analizar el lexema");
        ...
        jLabel1.setText("Buscar en el equipo");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(7, 7, 7)
                        .addComponent(btnArchivo, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(24, 24, 24)
                        .addComponent(jLabel1)))
        ...
        btnAnalizarSin.setText("Analizar la sintaxis");
    ...
    private void btnAnalizarSinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalizarSinActionPerformed
        ...
        Sintax s = new Sintax(new codificacion.LexerCup(new StringReader(ST)));

        try {
            s.parse();
            txtAnalizarSin.setText("No se encontro ningun error de sintaxis");
